...
public class ApiHttpClient {
    ...
    public static void getUrl(String partUrl, AsyncHttpResponseHandler handler) {
    ...
    public static void getUrl(String partUrl, RequestParams params,
                           AsyncHttpResponseHandler handler) {
    ...
    public static void postUrl(String partUrl, RequestParams params,
                            AsyncHttpResponseHandler handler) {
