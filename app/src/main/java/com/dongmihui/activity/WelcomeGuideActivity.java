...
import com.dongmihui.adapter.GuideViewPagerAdapter;
import com.dongmihui.common.AppContext;
import com.dongmihui.common.AppManager;
...
public class WelcomeGuideActivity extends Activity implements OnClickListener {
	...
	protected void onPause() {
		...
		// 如果切换到后台，就设置下次不进入功能引导页
		 SpUtils.putBoolean(WelcomeGuideActivity.this, AppContext.FIRST_OPEN, true);
