 ...
 */
package com.dongmihui.ui.easytagdragview.widget;
...
public class TipItemView extends RelativeLayout {
    ...
    private ChannelItem mIDragEntity;
    ...
    public ChannelItem getDragEntity() {
        return mIDragEntity;
    }

    public void renderData(ChannelItem entity) {
        mIDragEntity = entity;

        if (entity != null && entity != AbsTipAdapter.BLANK_ENTRY) {

            if(entity instanceof ChannelItem) {
                title.setText(((ChannelItem) mIDragEntity).getName());
   ...
   /* public void setDragDropListener(){
    ...
    public interface OnSelectedListener {
         ...
         */
        void onTileSelected(ChannelItem entity, int position, View view);

    }
    public interface OnDeleteClickListener{
        void onDeleteClick(ChannelItem entity, int position, View view);
    }
