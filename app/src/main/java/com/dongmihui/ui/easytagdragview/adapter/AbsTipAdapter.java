...
import com.dongmihui.ui.easytagdragview.listener.OnDragDropListener;
...
public abstract class AbsTipAdapter extends BaseAdapter implements
     ...
     */
    protected ArrayList<ChannelItem> tips = null;
    /**
     * Back up of（备份） the temporarily removed Contact during dragging.
     */
    private ChannelItem tempTip = null;
    /**
    ...
    public static ChannelItem BLANK_ENTRY = new ChannelItem() {
        private int id;
    ...
    public interface DragDropListener {
        ...
        void onDataSetChangedForResult(ArrayList<ChannelItem> list);
    }
    ...
    public AbsTipAdapter(Context context,
        ...
        mContext = context;
        tips = new ArrayList<ChannelItem>();
    ...
    //当数据改变时调用
    public void setData(List<ChannelItem> tips) {
     ...
     * @return
     */
    protected abstract ChannelItem getDragEntity(View view);
