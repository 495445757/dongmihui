package com.dongmihui.ui.easytagdragview;
...
import com.dongmihui.ui.easytagdragview.adapter.AbsTipAdapter;
import com.dongmihui.ui.easytagdragview.adapter.AddTipAdapter;
import com.dongmihui.ui.easytagdragview.adapter.DragTipAdapter;
import com.dongmihui.ui.easytagdragview.widget.DragDropGirdView;
...
public class EasyTipDragView extends RelativeLayout implements AbsTipAdapter.DragDropListener, TipItemView.OnDeleteClickListener,View.OnClickListener{
    ...
    private ArrayList<ChannelItem> lists;
    ...
    @Override
    public void onDataSetChangedForResult(ArrayList<ChannelItem> lists) {
        this.lists =lists;
    ...
    @Override
    public void onDeleteClick(ChannelItem entity, int position, View view) {
        addTipAdapter.getData().add(entity);
        addTipAdapter.refreshData();
        dragTipAdapter.getData().remove(position);
        dragTipAdapter.refreshData();
    }
    public void setDragData(List<ChannelItem> tips){
        dragTipAdapter.setData(tips);
    }
    public void setAddData(List<ChannelItem> tips){
    ...
    public interface OnDataChangeResultCallback{
        void onDataChangeResult(ArrayList<ChannelItem> tips);
    }
    //在最后点击"完成"关闭EasyTipDragView时回调
    public interface OnCompleteCallback{
        void onComplete(ArrayList<ChannelItem> tips);
    }
