...
package com.dongmihui.ui.swipebacklayout;
...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
         ...
         * default_im behavior is to leave edges unlocked.
         *
         * @param edgeFlags A combination of edge flags describing the edge(s)
         *                  locked
         ...
         * axis. The default_im implementation does not allow horizontal motion;
         ...
         * axis. The default_im implementation does not allow vertical motion; the
