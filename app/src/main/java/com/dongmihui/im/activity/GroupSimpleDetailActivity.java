...
public class GroupSimpleDetailActivity extends BaseActivity {
	...
	public static void startGroupSimpleDetailActivity(Activity activity, EMGroupInfo groupInfo) {
		if (activity != null) {
...
//		    group = PublicGroupsSeachActivity.searchedGroup;
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
                    ...
                    Log.d("GroupSimpleDetailActivi", "HyphenateException");
                    e.printStackTrace();
	...
	public void addToGroup(View view){
        Log.d("GroupSimpleDetailActivi", "onClick");
     ...
     private void showGroupDetail() {
         Log.d("GroupSimpleDetailActivi", "showGroupDtail");
         progressBar.setVisibility(View.INVISIBLE);
